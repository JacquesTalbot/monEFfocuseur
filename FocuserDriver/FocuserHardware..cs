...
//
// ASCOM Focuser hardware class for monEFfocuseur
//
	...
	internal static class FocuserHardware
	{
		...
		static FocuserHardware()
		{
			try
			{
				...
				tl = new TraceLogger("", "monEFfocuseur.Hardware");
		...
		public static bool Connected
		{
			...
			set
			{
				...
				if (value)
				{
					...
					objSerial.Port = Int32.Parse(comPort.Substring(3));
		...
		{
			objSerial.Transmit("mv" + Position + "#");
