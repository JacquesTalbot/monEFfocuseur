...
//
// ASCOM Focuser driver for monEFfocuseur
//
...
namespace ASCOM.monEFfocuseur.Focuser
{
	//
	...
	//
	// Your driver's DeviceID is ASCOM.monEFfocuseur.Focuser
	//
	// The COM Guid attribute sets the CLSID for ASCOM.monEFfocuseur.Focuser
	// The COM ClassInterface/None attribute prevents an empty interface called _monEFfocuseur from being created and used as the [default] interface
	//
	...
	/// </summary>
	[ComVisible(true)]
	[Guid("ac502a6f-42b2-4431-a628-62e7be9167dc")]
	[ProgId("ASCOM.monEFfocuseur.Focuser")]
	[ServedClassName("ASCOM Focuser Driver for monEFfocuseur")] // Driver description that appears in the Chooser, customise as required
	[ClassInterface(ClassInterfaceType.None)]
	public class Focuser : ReferenceCountedObjectBase, IFocuserV2, IDisposable
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="monEFfocuseur"/> class. Must be public to successfully register for COM.
		/// </summary>
		public Focuser()
		{
			try
			{
				...
				tl = new TraceLogger("", "monEFfocuseur.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
				SetTraceState();
			...
			catch (Exception ex)
			{
				...
				MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.monEFfocuseur.Focuser", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
